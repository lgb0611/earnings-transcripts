...
// 자동 컨콜 추출 함수 (API 호출 + 백업)
async function fetchEarnings(ticker) {
  try {
    const proxyUrl = 'https://api.allorigins.win/raw?url='; // CORS 우회
    ...
    console.error('API 오류 (백업 데이터 사용):', error);
    return [
      { quarter: 'Q3 2025', date: '2025-11-19', summary_en: 'Backup NVDA Q3 summary (3,000+ chars)...', summary_kr: '백업 요약 (3,000자 이상)...' },
      { quarter: 'Q2 2025', date: '2025-08-28', summary_en: 'Backup NVDA Q2 summary (3,000+ chars)...', summary_kr: '백업 요약 (3,000자 이상)...' }
    ];
  }
}
